...
<div class="upload-page-container">
    ...
    <div class="upload-card">
        ...
        <form action="{{ route('projects.documents.store', $project) }}" method="POST" enctype="multipart/form-data" class="upload-form">
            @csrf
            @if(!empty($fromOverview))
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" required
                    class="form-input"
                    placeholder="Contoh: Spesifikasi Sistem v1.0"
                    value="{{ old('title') }}">
                @error('title')
            ...
            <div class="form-group">
                ...
                <div class="file-drop-zone" id="drop-zone" onclick="document.getElementById('file-input').click()">
                    <input type="file" name="file" id="file-input" class="hidden-input" required onchange="handleFileSelect(this)">
                    <div class="drop-zone-content" id="drop-content">
                        ...
                        <p class="drop-zone-hint">PDF, DOCX, XLSX, PNG, JPG, ZIP — Maksimal 10MB</p>
                    </div>
