...
<div class="doc-detail-container">
    ...
    <div class="doc-detail-card">
        <div class="doc-detail-header">
            <div class="doc-detail-icon">
                @php
                    ...
                    elseif (in_array($ext, ['png', 'jpg', 'jpeg', 'gif'])) $iconClass = 'fa-file-image';
        ...
        <div class="doc-detail-actions">
            ...
            @endif
            <button onclick="document.getElementById('upload-modal').classList.remove('hidden')" class="doc-btn doc-btn-primary">
    ...
    <div class="doc-history-section">
        <div class="doc-history-header">
            ...
            <form action="{{ route('documents.destroy', $document) }}" method="POST" 
                  onsubmit="return confirm('Yakin ingin menghapus dokumen ini beserta SEMUA versinya? Tindakan ini tidak dapat dibatalkan.')">
                @csrf
                @method('DELETE')
            ...
            <div class="doc-history-item {{ $loop->first ? 'latest' : '' }}">
                ...
                <div class="doc-history-right">
                    ...
                    <div class="doc-history-actions">
                        <a href="{{ route('documents.download', $version) }}" class="doc-download-link" title="Download">
                            <i class="fas fa-download"></i>
                        </a>
                        @if($document->versions->count() > 1 || !$loop->first)
                        <form action="{{ route('document-versions.destroy', $version) }}" method="POST" 
                              onsubmit="return confirm('Hapus versi {{ $version->version_number }}?')" style="display: inline;">
                            @csrf
                            @method('DELETE')
        ...
        <form action="{{ route('documents.add-version', $document) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="doc-modal-body">
                <div class="doc-modal-notice">
                    ...
                    <p>Anda akan mengupload <strong>Versi {{ ($document->latestVersion->version_number ?? 0) + 1 }}</strong>. File lama tidak akan tertimpa dan tetap bisa diakses.</p>
                </div>
                ...
                <div class="doc-form-group">
                    ...
                    <textarea name="changelog" required rows="3" placeholder="Contoh: Perbaikan typo di halaman 5..."></textarea>
                </div>
            </div>

            <div class="doc-modal-footer">
                <button type="button" onclick="document.getElementById('upload-modal').classList.add('hidden')" class="doc-btn doc-btn-cancel">
                    Batal
                </button>
