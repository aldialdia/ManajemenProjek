...
@section('content')
        ...
        <div class="card-body">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1.5rem;">
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    <!-- Prev/Next Buttons -->
                    <button id="cal-prev" class="btn btn-secondary" style="padding: 0.5rem 0.75rem;"
                    ...
                    <div style="position: relative;">
                        <div id="calendar-title-btn"
                            style="display: flex; align-items: center; gap: 0.5rem; font-size: 1.125rem; font-weight: 600; color: #1e293b; cursor: pointer;">
                        ...
                        <div id="month-dropdown"
                            style="display: none; position: absolute; top: 100%; left: 0; margin-top: 0.5rem; background: white; border-radius: 8px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); z-index: 100; min-width: 200px; padding: 0.5rem 0;">
                            ...
                            <div id="month-list" style="max-height: 250px; overflow-y: auto;">
                                <div class="month-option" data-month="0" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    Januari</div>
                                <div class="month-option" data-month="1" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    Februari</div>
                                <div class="month-option" data-month="2" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    Maret</div>
                                <div class="month-option" data-month="3" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    April</div>
                                <div class="month-option" data-month="4" style="padding: 0.5rem 1rem; cursor: pointer;">Mei
                                </div>
                                <div class="month-option" data-month="5" style="padding: 0.5rem 1rem; cursor: pointer;">Juni
                                </div>
                                <div class="month-option" data-month="6" style="padding: 0.5rem 1rem; cursor: pointer;">Juli
                                </div>
                                <div class="month-option" data-month="7" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    Agustus</div>
                                <div class="month-option" data-month="8" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    September</div>
                                <div class="month-option" data-month="9" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    Oktober</div>
                                <div class="month-option" data-month="10" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    November</div>
                                <div class="month-option" data-month="11" style="padding: 0.5rem 1rem; cursor: pointer;">
                                    Desember</div>
                            </div>
                        </div>
                    </div>

                    <button id="cal-next" class="btn btn-secondary" style="padding: 0.5rem 0.75rem;"
                ...
                <div style="overflow-x: auto; position: relative;">
                    ...
                    @if(!$isManager)
                        <div id="gantt-overlay"
                            style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; z-index: 50; cursor: pointer;"></div>
                    @endif
                </div>
            @else
            ...
            <div style="display: flex; align-items: center; gap: 2rem; flex-wrap: wrap;">
                ...
                @foreach(\App\Enums\TaskStatus::cases() as $status)
                    <div style="display: flex; align-items: center; gap: 0.5rem;">
                        <div
                            style="width: 1rem; height: 1rem; border-radius: 4px; background-color: {{ $status->hexColor() }};">
                        </div>
    ...
    <div id="deadline-popup"
        ...
        <div
            style="background: white; border-radius: 16px; padding: 2rem; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); animation: popIn 0.3s ease-out;">
            <div
                style="width: 80px; height: 80px; background: linear-gradient(135deg, #fee2e2 0%, #fecaca 100%); border-radius: 50%; margin: 0 auto 1.5rem; display: flex; align-items: center; justify-content: center;">
                <i class="fas fa-calendar-times" style="font-size: 2rem; color: #ef4444;"></i>
            </div>
            <h3 style="font-size: 1.25rem; font-weight: 700; color: #1e293b; margin-bottom: 0.75rem;">Tanggal Tidak Valid
            </h3>
            ...
            <button onclick="closeDeadlinePopup()"
                style="background: linear-gradient(135deg, #6366f1 0%, #4f46e5 100%); color: white; border: none; padding: 0.75rem 2rem; border-radius: 8px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s;">
    ...
    <div id="project-deadline-popup"
        ...
        <div
            ...
            <h3 style="font-size: 1.25rem; font-weight: 700; color: #1e293b; margin-bottom: 0.75rem;">Melebihi Deadline
                Project</h3>
            <p style="color: #64748b; margin-bottom: 1.5rem; line-height: 1.6;">
            ...
            <button onclick="closeProjectDeadlinePopup()"
                style="background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); color: white; border: none; padding: 0.75rem 2rem; border-radius: 8px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s;">
                <i class="fas fa-check" style="margin-right: 0.5rem;"></i>Mengerti
            </button>
        </div>
    </div>

    <!-- Parent Task Deadline Popup Modal -->
    <div id="parent-deadline-popup"
        style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; align-items: center; justify-content: center;">
        <div
            style="background: white; border-radius: 16px; padding: 2rem; max-width: 400px; width: 90%; text-align: center; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); animation: popIn 0.3s ease-out;">
            <div
                ...
                <i class="fas fa-sitemap" style="font-size: 2rem; color: #d97706;"></i>
            </div>
            <h3 style="font-size: 1.25rem; font-weight: 700; color: #1e293b; margin-bottom: 0.75rem;">Melebihi Deadline
                Tugas Utama</h3>
            <p style="color: #64748b; margin-bottom: 1.5rem; line-height: 1.6;">
                <strong style="color: #d97706;">Deadline sub-tugas tidak boleh melebihi deadline tugas utama.</strong><br>
                <span id="parent-deadline-info" style="font-size: 0.875rem;">Deadline tugas utama: -</span>
            </p>
            <button onclick="closeParentDeadlinePopup()"
                style="background: linear-gradient(135deg, #d97706 0%, #b45309 100%); color: white; border: none; padding: 0.75rem 2rem; border-radius: 8px; font-size: 1rem; font-weight: 600; cursor: pointer;">
                <i class="fas fa-check" style="margin-right: 0.5rem;"></i>Mengerti
            </button>
        </div>
    </div>
    ...
    @push('styles')
        ...
        <style>
            ...
            @foreach(\App\Enums\TaskStatus::cases() as $status)
                .bar-{{ $status->value }} .bar {
                    fill:
                        {{ $status->ganttColors()['bar'] }}
                        !important;
                }

                .bar-{{ $status->value }} .bar-progress {
                    fill:
                        {{ $status->ganttColors()['progress'] }}
                        !important;
                }
    ...
    @push('scripts')
        ...
        <script>
                ...
                if (ganttTasks.length > 0) {
                    ...
                    new Gantt("#gantt", ganttTasks, {
                        ...
                        on_date_change: isManager ? function (task, start, end) {
                            ...
                            if (parentDueDate && moment(end).isAfter(moment(parentDueDate))) {
            ...
            function showParentDeadlinePopup(parentDueDate) {
                document.getElementById('parent-deadline-info').textContent = 'Deadline tugas utama: ' + parentDueDate;
                document.getElementById('parent-deadline-popup').style.display = 'flex';
            }
            ...
            document.getElementById('parent-deadline-popup').addEventListener('click', function (e) {
                if (e.target === this) {
                    closeParentDeadlinePopup();
                }
            });
